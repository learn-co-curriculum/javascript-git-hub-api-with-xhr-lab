...
function displayRepositories() {
  ...
  const repoList = "<ul>" + repos.map(repo => {
    ...
    let str = '<li><h2>' + repo.name + '</h2>'
    str += '<a href="' + repo.html_url + '">' + repo.html_url + '</a><br>'
    str += '<a href="#" ' + dataRepoName + ' ' + dataUsername + ' onclick="getCommits(this)">Get Commits</a><br>'
    str += '<a href="#" ' + dataRepoName + ' ' + dataUsername + ' onclick="getBranches(this)">Get Branches</a></li>'
    return str
  }).join('') + "</ul>";
